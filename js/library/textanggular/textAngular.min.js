    ...
    */
    ...
    angular.module("textAngularSetup", []).constant("taRegisterTool", c).value("taTools", e).value("taOptions", {
        ...
        toolbar: [
            ...
            ["html", "insertImage","embedFb","insertLink", "insertVideo", "wordcount", "charcount"]
        ],
        classes: {
            focussed: "focussed",
            toolbar: "btn-toolbar",
        ...
        // embedIG: {
        //     dialogPrompt: "Please enter to insert",
        //     tooltip: "Insert Url",
        //     hotkey: "the - possibly language dependent hotkey ... for some future implementation"
        // },
        // embedTw: {
        ...
        return {
            imgOnSelectAction: function(a, b, c) {
                ...
                a.preventDefault(), c.displayElements.popover.css("height", "200px");
        ...
        angular.forEach(["h1", "h2", "h3", "h4", "h5", "h6"], function(b) {
            ...
            tooltiptext: c.p.tooltip,
            action: function() {
                return this.$editor().wrapSelection("formatBlock", "<p class='red'>")
            },
            activeState: function() {
                return this.$editor().queryFormatBlockState("red")
            }
        }), a("blue", {
            buttontext: "Blue",
            tooltiptext: c.p.tooltip,
            action: function() {
                return this.$editor().wrapSelection("formatBlock", "<p class='blue'>")
            },
            activeState: function() {
                return this.$editor().queryFormatBlockState("blue")
            }
        }), a("green", {
            buttontext: "Green",
            tooltiptext: c.p.tooltip,
            action: function() {
                return this.$editor().wrapSelection("formatBlock", "<p class='green'>")
            },
            activeState: function() {
                return this.$editor().queryFormatBlockState("green")
            }
        }), a("yellow", {
            buttontext: "Yellow",
            tooltiptext: c.p.tooltip,
            action: function() {
                return this.$editor().wrapSelection("formatBlock", "<p class='yellow'>")
            },
            activeState: function() {
                return this.$editor().queryFormatBlockState("yellow")
            }
        }), a("pre", {
            buttontext: "pre",
        ...
        //     tooltiptext: c.embedIG.tooltip,
        //     action: function() {
        //         var a;
        //          if (a = b.prompt(c.embedIG.dialogPrompt,"")) {
        //             d.getSelectionElement().tagName && "a" === d.getSelectionElement().tagName.toLowerCase() &&
        //             d.setSelectionAfterElement(d.getSelectionElement());
        //             var e = a;
        //             return this.$editor().wrapSelection("insertHTML", e)
        //         }
        //     }
        // }), a("embedTw", {
        //     iconclass: "fa fa-twitter",
        //     tooltiptext: c.embedTw.tooltip,
        //     action: function() {
        //         var a;
        //          if (a = b.prompt(c.embedTw.dialogPrompt,"")) {
        //             d.getSelectionElement().tagName && "a" === d.getSelectionElement().tagName.toLowerCase() &&
        //             d.setSelectionAfterElement(d.getSelectionElement());
        //             var e = a;
        //             return this.$editor().wrapSelection("insertHTML", e)
        ...
        //     }
            ...
            tooltiptext: c.embedFb.tooltip,
            action: function() {
                var a;
                 if (a = b.prompt(c.embedFb.dialogPrompt,"")) {
                    d.getSelectionElement().tagName && "a" === d.getSelectionElement().tagName.toLowerCase() &&
                    d.setSelectionAfterElement(d.getSelectionElement());
                    // var e = "<div class='fb-post' id='embedfb' href='"+a+"' show-text='true'><blockquote cite='"+a+"' class='fb-xfbml-parse-ignore'></blockquote></div>";
                    var e = "<div class='facebook-responsive'>"+a+"</div>";
                    return this.$editor().wrapSelection("insertHTML", e)
                }
            }
        }), a("wordcount", {
    ...
    angular.module("textAngular.factories", []).factory("taBrowserTag", [function() {
        ...
        var a = function(a, b) {
            ...
            //
            /////////////////////////////////////////////////////////////
            if ( /* istanbul ignore next: apple-contereted-space span has matched */ i && (
                    // modified....
        ...
        function d(a) {
            ...
            for (
                ...
                /style=("([^"]+)"|'([^']+)')/gi.test(f) ? /* istanbul ignore next: quotations match */ f = f.replace(/style=("([^"]+)"|'([^']+)')/i, 'style="$2$3 text-align:' + (b[3] || b[4]) + ';"') : /* istanbul ignore next: quotations match */ f += ' style="text-align:' + (b[3] || b[4]) + ';"', f += ">",
                    // add to html
                    d += f
            }
                                ...
                                if (E === x) {
                                    ...
                                    if (E.match(j))
                                        ...
                                        if (
                                            ...
                                            for (t = angular.element(q), t[0].innerHTML = u, v[0].parentNode.insertBefore(t[0], v[0]), s = v.length - 1; s >= 0; s--) /* istanbul ignore else:  */ v[s].parentNode && v[s].parentNode.removeChild(v[s])
                                    ...
                                    var M = t.parent(),
                                        N = M.contents();
                                    for (s = 0; s < N.length; s++) /* istanbul ignore next: can't test - some wierd thing with how phantomjs works */ M.parent().hasClass("ta-bind") && 3 === N[s].nodeType && (A = angular.element("<" + h + ">"), A[0].innerHTML = N[s].outerHTML, N[s] = A[0]), M.parent()[0].insertBefore(N[s], M[0]);
                                    M.remove()
                                }
            ...
            link: function(f, r, u, v) {
                ...
                var Y, Z = function() {
                    ...
                    da = f["$redoTaBind" + (u.id || "")] = function() { /* istanbul ignore else: can't really test it due to all changes being ignored as well in readonly */
                        if (!F && D) {
                            ...
                            "undefined" != typeof a && null !== a && (ba(a), aa(a, !1), /* istanbul ignore next */ Y && c.cancel(Y), Y = c(function() {
                                r[0].focus(), h.setSelectionToElementEnd(r[0])
                            }, 1))
                        }
                    };
                ...
                if (
                    ...
                    if (f.events = {}, D) {
                        ...
                        r.on("paste", f.events.paste = function(b, e) {
                            ...
                            if ( /* istanbul ignore next: difficult to test */ o.keyMappings.forEach(function(b) {
                                ...
                                }), /* istanbul ignore next: difficult to test */ "undefined" != typeof c && (a.specialKey = c), /* istanbul ignore next: difficult to test as can't seem to select */ "undefined" == typeof a.specialKey || "UndoKey" === a.specialKey && "RedoKey" === a.specialKey || (a.preventDefault(), s.sendKeyCommand(f, a)), !(F || ("UndoKey" === a.specialKey && (ca(), a.preventDefault()), "RedoKey" === a.specialKey && (da(), a.preventDefault()), a.keyCode !== Q || a.shiftKey || a.ctrlKey || a.metaKey || a.altKey))) {
                        ...
                        if (r.on("input", function() {
                                Z() !== B.$viewValue && (
                                    ...
                                    ia && c.cancel(ia), /* istanbul ignore next: cant' test? */ ia = c(function() {
                        ...
                        r.on("change blur", f.events.change = f.events.blur = function() {
                            ...
                            if ( /* istanbul ignore else: this is for catching the jqLite testing*/ b && angular.extend(a, b), a.keyCode === S) { // tab was pressed
                ...
                B.$render = function() { /* istanbul ignore if: Catches rogue renders, hard to replicate in tests */
                        if (!pa) {
                            ...
                            H || ( /* istanbul ignore else: in other cases we don't care */ D && G && (
                                    // update while focussed
                                    r.removeClass("placeholder-text"), /* istanbul ignore next: don't know how to test this */ na && c.cancel(na), na = c(function() { /* istanbul ignore if: Can't be bothered testing this... */
