...
! function(a, b, c) {
    ...
    var m = b.$$minErr("$sanitize"),
        ...
        B = f("rp,rt"),
        C = b.extend({}, B, A),
        D = b.extend({}, A, f("iframe,address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,script,section,table,ul")),
